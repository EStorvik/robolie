""" Rotations in two spatial dimensions. Including exponential and logarithmic maps to and from the lie algebra of the unit circle/two-dimensional rotation group. """
